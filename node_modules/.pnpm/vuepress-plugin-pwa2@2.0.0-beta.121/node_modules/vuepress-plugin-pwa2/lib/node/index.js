import{useSassPalettePlugin as I}from"vuepress-plugin-sass-palette";import{Logger as z,getRootLang as S,getLocales as x,addViteOptimizeDepsExclude as C,useCustomDevServer as j}from"vuepress-shared/node";import{fs as h,chalk as g,path as b,getDirname as P}from"@vuepress/utils";import{generateSW as T}from"workbox-build";import{ensureEndingSlash as O}from"@vuepress/shared";const m=new z("vuepress-plugin-pwa2"),v=({options:e,deprecatedOption:a,newOption:n,msg:t="",scope:o=""})=>{if(a in e){if(m.warn(`"${a}" is deprecated${o?` in ${o}`:""}, please use "${n}" instead.${t?`
${t}`:""}`),n.includes(".")){const p=n.split(".");let i=e;p.forEach((s,l)=>{l!==p.length-1?(i[s]=i[s]||{},i=i[s]):i[s]=e[a]})}else e[n]=e[a];delete e[a]}},$=e=>{v({options:e,deprecatedOption:"cacheMaxSize",newOption:"maxSize"}),v({options:e,deprecatedOption:"popupComponent",newOption:"updateComponent"})},A=async(e,a)=>{var n,t,o;const{dir:p,siteData:i}=e,{base:s}=e.options,l=p.source(".vuepress/public/manifest.webmanifest"),r=p.source(".vuepress/public/manifest.json"),c=a.manifest||{},u=JSON.parse(h.existsSync(l)?await h.readFile(l,"utf8"):h.existsSync(r)?await h.readFile(r,"utf8"):"{}");return{name:i.title||((n=i.locales["/"])==null?void 0:n.title)||"Site",short_name:i.title||((t=i.locales["/"])==null?void 0:t.title)||"Site",description:i.description||((o=i.locales["/"])==null?void 0:o.description)||"A site built with vuepress",lang:S(e),start_url:s,scope:s,display:"standalone",theme_color:a.themeColor||"#46bd87",background_color:"#ffffff",orientation:"portrait-primary",prefer_related_applications:!1,...u,...c}},W=async(e,a)=>{m.load("Generating manifest.webmanifest");const{dir:n}=e,t=n.dest("manifest.webmanifest");await h.writeJSON(t,await a,{flag:"w"}),m.succeed(),m.update(`Manifest generated and saved to ${g.cyan(b.relative(process.cwd(),t))}!`)},N=(e,a=1024)=>n=>{const t=[],o=[],p=[".png",".jpg",".jpeg","webp","bmp","gif"];for(const i of n)if(p.some(s=>i.url.endsWith(s))){const s=h.statSync(b.resolve(e,i.url));s.size>a*1024?t.push(`Skipped ${i.url}, as it's ${Math.ceil(s.size/1024)} KB.`):o.push(i)}else o.push(i);return{warnings:t,manifest:o}},D=async(e,a)=>{var n;m.load("Generating service worker");const{dest:t}=e.dir,{title:o,locales:p}=e.siteData,i=t("service-worker.js"),s=b.relative(process.cwd(),t()),l=["**/*.{js,css,svg,woff,woff2,eot,ttf,otf}"];a.cacheHTML?l.push("**/*.html"):l.push("./index.html","./404.html"),a.cachePic&&l.push("**/*.{png,jpg,jpeg,bmp,gif,webp}"),await T({swDest:i,globDirectory:s,cacheId:o||((n=p["/"])==null?void 0:n.title)||"hope",globPatterns:l,cleanupOutdatedCaches:!0,clientsClaim:!0,maximumFileSizeToCacheInBytes:(a.maxSize||2048)*1024,manifestTransforms:[N(s,a.maxPicSize)],...a.generateSWConfig||{}}).then(({count:r,size:c,warnings:u})=>{m.succeed(),m.info(`Precache ${g.cyan(`${r} files`)}, totaling ${g.cyan(`${(c/1024/1024).toFixed(2)} Mb.`)}.`),u.length&&m.warn(`
${u.map(y=>`  · ${y}`).join(`
